...
finviz_weekly_img_url = "http://finviz.com/chart.ashx?t=%s&ty=c&ta=0&p=w&s=l"
finviz_monthly_img_url = "http://finviz.com/chart.ashx?t=%s&ty=c&ta=0&p=m&s=l"
...
cnn_markets_url = "http://money.cnn.com/data/markets/"

bbg_quote_url = "https://www.bloomberg.com/quote/%s:US"

dropbox_coef_url = "https://www.dropbox.com/s/h4037joe0obr1h9/coef.txt"
...
sticky_dict = {'DIA': 1, 'VOO': 1, 'ONEQ': 1, 'VIXM': 1}
markets_lst = ['Dow', 'S&P', 'Nasdaq']
