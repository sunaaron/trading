...
def gen_fund_caption():
    ...
    caption_str += "RSI" + "\t"
    caption_str += "MA_Diff" + "\t"
    caption_str += "Days since MA0" + "\t"
    caption_str += "Gain Since MA0" + "\t"
...
def gen_fund_row(symbol_obj):
    ...
    row_str += str(symbol_obj.rsi_value()) + "\t"
    row_str += str(symbol_obj.ma_diff_ratio()) + "\t"
    row_str += str(symbol_obj.ma_rally_days()) + "\t"
    row_str += str(symbol_obj.ma_rally_gain()) + "\t"
